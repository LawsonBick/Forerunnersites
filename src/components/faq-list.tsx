    ...
    <div className="divide-y divide-line border-y border-line" data-reveal>
      {faqs.map((faq) => (
        <details key={faq.question} className="group">
          <summary className="flex cursor-pointer items-center justify-between gap-6 py-5 text-left text-[15px] font-medium text-ink transition-colors hover:text-ink">
            {faq.question}
            <span
              aria-hidden="true"
